...
plugins=(git colorize colored-man-pages 1password command-not-found emoji-clock aliases npm nvm qrcode sdk)
...
# update the chezmoi-managed Brewfile
brew() {
  command brew "$@"
...
# Created by `pipx` on 2025-06-21 13:40:10
